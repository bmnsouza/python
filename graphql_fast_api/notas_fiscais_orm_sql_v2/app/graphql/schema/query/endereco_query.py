...
class EnderecoQuery:
    @strawberry.field
    async def get_enderecos(self, info: Info, limit: int = 50) -> List[EnderecoType]:
    ...
    @strawberry.field
    async def get_enderecos_por_contribuinte(self, info: Info, cd_contribuinte: str) -> List[EnderecoType]:

...
from app.graphql.schema.type.danfe_type import DanfeType, SingleResponseDanfeType
...
class DanfeMutation:
    ...
    @strawberry.mutation
    async def create_danfe(self, info: Info, cd_contribuinte: str, numero: str, valor_total: float, data_emissao: datetime) -> SingleResponseDanfeType:
        try:
    ...
    @strawberry.mutation
    async def update_danfe(self, info: Info, id_danfe: int, numero: str, valor_total: float, data_emissao: datetime) -> SingleResponseDanfeType:
        try:
            session = info.context["session"]
    ...
    @strawberry.mutation
    async def delete_danfe(self, info: Info, id_danfe: str) -> SingleResponseDanfeType:
        try:
            session = info.context["session"]
